                            ...
                            <div class="card-body">
                                ...
                                <form id="addType">
                                    <div class="col-md-s12 form-group">
                                        <label for="exampleFormControlSelect1">Nombre de tipo de incident</label>
                                        <input name="typeName" class="form-control" placeholder="inserte el nombre" data-style="btn btn-link" required>
                                        </input>
                                    </div>
